...
// SVG Icons
const TruckIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-fuchsia-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    return (
        <section>
             <div className="grid grid-cols-1 md:grid-cols-2">
                <div className="bg-rose-50 flex items-center py-12 px-8 md:px-12 order-2 md:order-1">
                ...
                <div 
                    ...
                    style={{ backgroundImage: "url('https://storage.googleapis.com/aistudio-public/gallery/2c20f140-6246-430b-b27b-23a5121f1e32.jpg')" }}
                />
            </div>
        </section>
    );
